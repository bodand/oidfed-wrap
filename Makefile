...
LIB_ARCHIVE := liboidfed_wrap${TGT_SFX}
...
${LIB_ARCHIVE}: oidfed_wrap_lib${OUT_SFX}
	cp oidfed_wrap_lib${OUT_SFX} $@

oidfed_wrap_lib.h oidfed_wrap_lib${OUT_SFX}: ${GO_SRC} oidfed_wrap.h
	${GOC} ${GOFLAGS} ${GO_SRC}

.PHONY: clean
clean:
	-rm -f ${LIB_ARCHIVE} ${LIB_HEADER} oidfed_wrap_lib${OUT_SFX}
	-rm -f demo
